    ...
    return (
        <div className='pt-2' id='contact'>
            <Container className='pt-4'>
                ...
                <Row className='p-lg-2 text-white g-4 g-md-5 gy-sm-3 gy-xm-3'>
                    {
                        ContactItems.map(item => (
                            <Col sm={6} md={6} lg={3} className='col-12'>
                                <div className='contact-card bg-green d-flex flex-column align-items-center'>
                                    <div className='address-icons fs-1 pt-lg-5 pt-2'>
                                        <Icon icon={item.icon} />
                                    </div>
                                    <p className='pt-2 pt-lg-5 pb-1 pb-lg-3 text-center fs-5 text-uppercase'>{item.name}</p>
                ...
                <Row className='pt-5'>
                    <Col sm={12} md={6} lg={6} className='d-flex flex-column align-items-center pb-5 pt-3 order-2 order-sm-2 order-md-1 order-lg-1'>
                        <MapContainer />
                    </Col>
                    <Col sm={12} md={6} lg={6} className='order-1 order-sm-1 order-md-2 order-lg-2'>
                        <Form className='p-4'>
                            ...
                            <div className='d-flex d-sm-block flex-column align-items-center justify-content-center'>
                                <button className='btn btn-green text-white rounded-pill px-3 py-2 px-md-5 py-md-3'>Send Message</button>
                            </div>
                        </Form>
                    </Col>
                </Row>
